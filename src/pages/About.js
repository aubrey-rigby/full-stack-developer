  ...
  return (
    <div className="row">
      ...
      <div className="mt-2 col-sm-12 col-md-7 col-lg-8">       
        ...
        <a href="https://aubrey-100-days-of-code.herokuapp.com/" target="_blank" rel="noreferrer"><button  id="resume-btn" className="my-2 btn"><i class="fas fa-chart-line" style={{marginRight:"10px"}}></i>Watch me progress through 100 days of code</button></a>
      </div>                
      </div>
  );
}
